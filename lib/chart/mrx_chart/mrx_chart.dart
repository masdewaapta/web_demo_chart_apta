...
List<ChartLayer> layersBarChart() {
  return [
    ChartAxisLayer(
...
List<ChartLayer> layersCandleChart() {
...
_candleItem(
    Color color, double min1, double max1, double min2, double max2, double x) {
...
List<ChartLayer> layersGroupBarChart() {
  return [
    ChartAxisLayer(
      settings: ChartAxisSettings(
        x: ChartAxisSettingsAxis(
...
List<ChartLayer> layersLineChart() {
...
List<ChartLayer> layersPieChart() {
  return [
    ChartGroupPieLayer(
      items: List.generate(
        2,
